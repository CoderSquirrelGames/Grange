...
namespace NodeCanvas.Tasks.Actions{
	...
	public class SendEvent : ActionTask<GraphOwner> {
		...
		protected override string info{
			get{ return (sendGlobal? "Global " : "") + "Send [" + eventName + "]" + (delay.value > 0? " after " + delay + " sec." : "" );}
		}
	...
	[Category("✫ Utility")]
	[Description("Send a graph event with T value. If global is true, all graphs in scene will receive this event. Use along with the 'Check Event' Condition")]
