...
namespace ParadoxNotion.Design{
	...
	partial class EditorUtils {
		...
		public static BBParameter BBParameterField(string prefix, BBParameter bbParam, bool blackboardOnly = false, MemberInfo member = null, bool isPersistant = false){
			...
			if (!blackboardOnly && !bbParam.useBlackboard){
				...
				bbParam.value = GenericField(prefix, bbParam.value, bbParam.varType, member, isPersistant);
