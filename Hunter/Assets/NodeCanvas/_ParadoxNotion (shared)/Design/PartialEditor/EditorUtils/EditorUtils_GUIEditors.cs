...
namespace ParadoxNotion.Design{
	...
	partial class EditorUtils {
		...
		//A list editor
		public static IList ListEditor(string prefix, IList list, Type listType, bool isPersistant = false){
			...
			for (var i = 0; i < list.Count; i++){
				...
				list[i] = GenericField("Element " + i, list[i], argType, null, isPersistant);
		...
		//A dictionary editor
		public static IDictionary DictionaryEditor(string prefix, IDictionary dict, Type dictType, bool isPersistant = false){
			...
			for (var i = 0; i < keys.Count; i++){
				...
				keys[i] = GenericField("K:", keys[i], keyType, null, isPersistant);
				values[i] = GenericField("V:", values[i], valueType, null, isPersistant);
				GUILayout.EndVertical();
				GUILayout.EndHorizontal();
